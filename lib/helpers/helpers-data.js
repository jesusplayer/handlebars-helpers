...
var helpers = {
   ...
   * {{get this "{{get table '0'}}" }}  // return My Name
   * 
   * Extract a value of a specific property into a Javascript Object
   * @param  {[Object or Function]} object_or_fn [The Javascript Object or function to call]
   * @param  {[string]} valuePath     [the string contain a ptath to the value, it can also contains a Handlebars syntax]   * @return {[type]} */
  get: function (Object_or_fn, ValuePath, options) {
        ...
        valuePath = Handlebars_copy.compile(valuePath)(this);
